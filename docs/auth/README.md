...
GitHub App の Client ID、base64 化した private key、installation ID を `XLAIR_GITHUB_APP_CLIENT_ID`、`XLAIR_GITHUB_APP_PRIVATE_KEY_BASE64`、`XLAIR_GITHUB_APP_INSTALLATION_ID` として GitHub Actions secrets に登録する。private key はリポジトリに保存しない。
